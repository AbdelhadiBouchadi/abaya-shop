...
export default function HeroSection() {
  ...
  return (
    <div className="mx-auto flex flex-col md:flex-row items-center justify-center gap-16">
      <div className="grid grid-cols-[1fr_1.2fr] grid-rows-2 gap-6 w-full ">
        <div
          ref={sneakerRef}
        ...
        >
          ...
          >
            <span className="stroke-layer2 font-normal tracking-tight">
              <span className="hidden lg:block text-[20px] xl:text-[22px] leading-[1.4]">
                Curated essentials
              </span>

              <span className="block text-[11px] sm:text-[12px] md:text-[13px] lg:text-[14px] xl:text-[16px] mt-3 leading-1.5">
                for a simpler life.
              </span>
            </span>
          </div>
